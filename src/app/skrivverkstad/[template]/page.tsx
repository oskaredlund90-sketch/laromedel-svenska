        ...
        <div className="grid gap-4 sm:grid-cols-2">
          <ExampleCard title="1. Inledning med tes">
            ...
            <Tip>
              ...
              &quot;Mobbing är dåligt&quot; är för vagt. &quot;Skolan borde införa
          ...
          <ExampleCard title="3. Motargument">
            ...
            <Warning>
              ...
              motståndarens bästa argument och bemöt dem seriöst.
            </Warning>
          </ExampleCard>
      ...
      <Section title="Struktur">
        <div className="grid gap-4 sm:grid-cols-2">
          ...
          <ExampleCard title="4. Avslutning med poäng">
            <p className="mb-2 text-sm text-neutral-600 dark:text-neutral-400">
              Avsluta med en poäng, en tankeställare eller en cirkelkomposition
...
export async function generateMetadata({ params }: Props) {
  ...
  if (!t) return {};
  return { title: `${t.title} – Skrivverkstad` };
}
